...
import com.kokakiwi.mclauncher.ui.simple.components.TestPanel;
...
public class SimpleLoginPage implements Page
{
    ...
    private final TransparentLabel statusText = new TransparentLabel("",
                                                      SwingConstants.CENTER, Color.GREEN);
    ...
    public SimpleLoginPage()
    {
        userName.addKeyListener(new KeyAdapter() {
            ...
            {
              //  statusText.setText("Bienvenue sur EvOrigin "+ userName.getText());
            }
        });
    ...
    private void buildLoginBox(boolean offline)
    {
        ...
        titles.add(new TransparentLabel(Translater
                .getString("login.usernameLabel") + " :", 4, Color.RED));
        titles.add(new TransparentLabel(Translater
                .getString("login.passwordLabel") + " :", 4, Color.RED));
        titles.add(new TransparentLabel("", 4, Color.WHITE));
